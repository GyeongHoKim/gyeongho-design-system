...
React Native does not support CSS font stacks or `@font-face`. RN uses the platform's native font
system — iOS (Apple SD Gothic Neo) and Android (Noto Sans) provide Korean glyphs automatically.
See `packages/react-native/AGENTS.md` for RN-specific font guidance.
