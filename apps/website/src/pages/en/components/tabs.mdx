...
<KeyboardTable
  rows={[
    { keys: 'Arrow keys', action: 'Move to and activate the previous/next tab (wraps).' },
    { keys: 'Home / End', action: 'Activate the first / last tab.' },
    { keys: 'Tab', action: 'Move focus out of the tablist to the active panel.' },
  ]}
/>
